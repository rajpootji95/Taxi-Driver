...
import 'package:why_taxi_driver/BookRide/rate_ride_dialog.dart';
  ...
  getTime1(lat1, lon1, lat2, lon2) async {
    if (lat1 != "" &&
      ...
      http.Response response = await http.get(Uri.parse(
          "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=${lat1},${lon1}&destinations=${lat2},${lon2}&key=AIzaSyDG_ncXeeNI_VRgQEu4eJHos5eCtspgTjE"));
      print(response.body);
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) => PlacePicker(
                                              apiKey: Platform.isAndroid
                                                  ? "AIzaSyDG_ncXeeNI_VRgQEu4eJHos5eCtspgTjE"
                                                  : "AIzaSyDG_ncXeeNI_VRgQEu4eJHos5eCtspgTjE",
