...
import 'package:why_taxi_driver/DrawerPages/Wallet/send_to_bank_page.dart';
...
import 'package:why_taxi_driver/utils/Razorpay.dart';
                         ...
                         /* InkWell(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: text(
                                      getTranslated(context, "Withdrawmoney")!,
                                      fontFamily: fontMedium,
                                      fontSize: 10.sp,
                                      isCentered: true,
                                      textColor: Colors.white)),
                                      ...
                                      child: ListTile(
                                        ...
                                        title: Text(
                                          walletList[index].note != null
                                              ...
                                              : "Transaction ID - ${walletList[index].txnId}",
                                        ...
                                        trailing: Column(
                                          ...
                                          children: [
                                            Text(
                                              walletList[index].note!=null&&walletList[index].note!.toLowerCase().contains("withdrawal")?"${walletList[index].note!.toLowerCase().contains("disapproved")?"+":walletList[index].note!.toLowerCase().contains("waiting")?"":"-"}\u{20B9}${walletList[index].balance}":'${walletList[index].sign == "+" ? walletList[index].sign : "-"}\u{20B9}${walletList[index].balance}',
                                              style: theme.textTheme.headline6!
                                                  .copyWith(
                                                      color: walletList[index].note!=null&&walletList[index].note!.toLowerCase().contains("withdrawal")?walletList[index].note!.toLowerCase().contains("waiting")?Colors.grey:walletList[index].note!.toLowerCase().contains("disapproved")?Colors.green:Colors.red:walletList[index]
                                                                  .sign ==
                                                              "+"
                                                          ? Colors.green
                                                          : Colors.red,
