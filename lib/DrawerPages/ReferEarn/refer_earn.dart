...
import 'package:why_taxi_driver/Model/refer_model.dart';
...
class _ReferEarnState extends State<ReferEarn> {
  String referCode = "",
      title = "Delris Driver App\n",
      des =
          "You can use this code to refer your friends \nto Delris  Driver App and get rewarded";
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: Color(
              0xffF36B21), //<- background color to combine with the picture :-)
        ),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xffF36B21),
                          ),
                          onPressed: () {
