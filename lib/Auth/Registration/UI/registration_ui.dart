...
import 'package:why_taxi_driver/Auth/BankDetails/UI/bank_details_page.dart';
import 'package:why_taxi_driver/Auth/Verification/UI/verification_page.dart';
...
import 'package:why_taxi_driver/Model/cab_model.dart';
                    ...
                    children: [
                     ...
                     /* EntryField(
                      ...
                      Container(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 20, right: 20),
                          child: Text(getTranslated(context, "UPLOAD_PASS")!+"(Optional)"),
                        ),
                      ),
                      SizedBox(height: 10),
                      InkWell(
                      ...
                      Container(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 20, right: 20),
                          child: Text(getTranslated(context, "UPLOAD_INS")!+"(Optional)"),
                        ),
                      ),
                      SizedBox(height: 10),
                      InkWell(
                      ...
                      Container(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 20, right: 20),
                          child: Text(getTranslated(context, "UPLOAD_BANK")!+"(Optional)"),
                        ),
                      ),
                      SizedBox(height: 10),
                      InkWell(
                      ...
                      Container(
                        child: Padding(
                          padding: const EdgeInsets.only(left: 20, right: 20),
                          child:
                              Text(getTranslated(context, "UPLOAD_VEHICLE")!),
                        ),
                      ),
                      SizedBox(height: 10),
                      InkWell(
          ...
          ? Container(
              ...
              child: CustomButton(
                ...
                onTap: () {
                  ...
                  // }
                  if (genderCon.text == "") {
                    UI.setSnackBar("Please Select Gender", context);
                    return;
                  }
                  if (dobCon.text == "") {
                  ...
                  if (vehicleCon.text == "" || vehicleCon.text.length != 10) {
                    UI.setSnackBar("Please Enter Valid Vehicle Number", context);
                    return;
                  }
                  if (accountCon.text == "" || accountCon.text.length < 10) {
                    UI.setSnackBar("Please Enter Valid Account Number", context);
                    return;
                  }
                  if (bankCon.text == "") {
                    UI.setSnackBar("Please Enter Valid Bank Name", context);
                    return;
                  }
                  if (codeCon.text == "" || codeCon.text.length != 11) {
                    UI.setSnackBar("Please Enter Valid IFSC Code", context);
                    return;
                  }
                  if (_image == null) {
                  ...
                  if (_finalImage == null) {
                    UI.setSnackBar("Please Upload Document Photo", context);
                    return;
                  }
                  // if (panImage == null) {
                  //   UI.setSnackBar(
                  ...
                  // }
                  if (adharImage == null) {
                    UI.setSnackBar("Please Upload Adhar Photo", context);
                    return;
                  }
                  ...
                  if (vehicleImage == null) {
                    UI.setSnackBar("Please Upload Vehicle Photo", context);
                    return;
                  }
                  setState(() {
                    loading = true;
