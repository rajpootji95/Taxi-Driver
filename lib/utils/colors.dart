...
class MyColorName {
  ...
  static const Color primaryDark = Color(0xFF2596be);
  static const Color appbarBg = Color(0xFF2596be);
  static const Color colorTextPrimary = Color(0xff28728D);
  static const Color colorTextSecondary = Color(0xff474747);
  static const Color colorTextFour = Color(0xFF2596be);
  ...
  static const Color colorTextThird = Color(0xFF2596be);
