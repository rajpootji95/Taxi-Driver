...
final String appName = 'Delris Cab Driver';
bool notificationStatus = true;
int notificationId = 1;
final String packageName = 'com.delriscab.driver';
const String languageCode = 'languageCode';
final String baseUrl =
    // 'https://developmentalphawizz.com/why_taxi/api/Authentication/';
    //'https://admin.whytaxi.com/api/Authentication/';
    'https://alphataxi.productsalphawizz.com/api/Authentication/';
...
// final String baseUrl1 = 'https://developmentalphawizz.com/why_taxi/api/';
final String baseUrl1 = 'https://alphataxi.productsalphawizz.com/api/';
